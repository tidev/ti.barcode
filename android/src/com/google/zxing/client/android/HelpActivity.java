...
public final class HelpActivity extends Activity {
  ...
  protected void onCreate(Bundle icicle) {
    ...
    setContentView(RHelper.getLayout("help"));

    webView = (WebView)findViewById(RHelper.getId("help_contents"));
    ...
    backButton = (Button) findViewById(RHelper.getId("back_button"));
    backButton.setOnClickListener(backListener);
    View doneButton = findViewById(RHelper.getId("done_button"));
