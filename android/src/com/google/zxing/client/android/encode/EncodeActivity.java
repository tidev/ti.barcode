...
public final class EncodeActivity extends Activity {
  ...
  private void share() {
    ...
    if (!barcodesRoot.exists() && !barcodesRoot.mkdirs()) {
      ...
      showErrorMessage(RHelper.getString("msg_unmount_usb"));
      return;
    }
    ...
    intent.putExtra(Intent.EXTRA_SUBJECT, getString(RHelper.getString("app_name")) + " - " + encoder.getTitle());
  ...
  protected void onResume() {
    ...
    try {
      ...
      if (bitmap == null) {
        ...
        showErrorMessage(RHelper.getString("msg_encode_contents_failed"));
        qrCodeEncoder = null;
        return;
      }

      ImageView view = (ImageView) findViewById(RHelper.getId("image_view"));
