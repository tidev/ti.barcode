...
public final class PreferencesFragment 
  ...
  public void onCreate(Bundle icicle) {
    ...
    addPreferencesFromResource(RHelper.getXML("preferences"));
  ...
  private class CustomSearchURLValidator implements Preference.OnPreferenceChangeListener {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
      if (!isValid(newValue)) {
        ...
        builder.setTitle(RHelper.getString("msg_error"));
        builder.setMessage(RHelper.getString("msg_invalid_value"));
