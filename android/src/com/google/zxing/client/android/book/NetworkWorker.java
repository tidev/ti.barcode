  ...
  public void run() {
    try {
      ...
      try {
        ...
        Message message = Message.obtain(handler, RHelper.getId("search_book_contents_succeeded"));
        message.obj = json;
        message.sendToTarget();
      } catch (IOException ioe) {
        Message message = Message.obtain(handler, RHelper.getId("search_book_contents_failed"));
        message.sendToTarget();
      }
